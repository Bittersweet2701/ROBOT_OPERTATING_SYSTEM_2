...
static const _AddTwoInt_Request_type_support_symbol_names_t _AddTwoInt_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bumperbot_msgs, srv, AddTwoInt_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bumperbot_msgs, srv, AddTwoInt_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, bumperbot_msgs, srv, AddTwoInt_Request)() {
  return &::bumperbot_msgs::srv::rosidl_typesupport_c::AddTwoInt_Request_message_type_support_handle;
}
...
static const _AddTwoInt_Response_type_support_symbol_names_t _AddTwoInt_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bumperbot_msgs, srv, AddTwoInt_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bumperbot_msgs, srv, AddTwoInt_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, bumperbot_msgs, srv, AddTwoInt_Response)() {
  return &::bumperbot_msgs::srv::rosidl_typesupport_c::AddTwoInt_Response_message_type_support_handle;
}
...
static const _AddTwoInt_type_support_symbol_names_t _AddTwoInt_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bumperbot_msgs, srv, AddTwoInt)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bumperbot_msgs, srv, AddTwoInt)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, bumperbot_msgs, srv, AddTwoInt)() {
  return &::bumperbot_msgs::srv::rosidl_typesupport_c::AddTwoInt_service_type_support_handle;
}
